package sg.edu.nus.iss.app.day28googleplaystore.repository;
...
import static sg.edu.nus.iss.app.day28googleplaystore.Constants.*;
...
public class AppsRepository {
    ...
    {
    $group: {_id: "$Category", apps: { $push: "$App"}, averageRating: {$avg: "$Rating"}}   
    }
    ]);
     */
